...
const AthleteChatRoom = () => {
    ...
    fetch(`${API_URL}/user/contacts`, {
      ...
      .then((data) => {
        if (data.success === true) {
          // Map contacts data to the required structure
  ...
  return (
    <div className="py-4">
      ...
      <Layout className="chat-layout position-relative">
        <Sider
        ...
        >
          ...
          <div className="overflow-auto" style={{ height: "65vh" }}>
            ...
            />
            <h4 className="px-3 ff-gotham-medium fs_18">Contacts</h4>
            <List
              itemLayout="horizontal"
              className="px-3 overflow-auto"
                  ...
                  <div className="ff-gotham-normal d-flex gap-2 align-items-center cursor-pointer">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        className="fs_12 mb-0 text-wrap"
                      >
                    ...
                    chats[selectedUser.id].map((chat, index) => {
                      return (
                        ...
                        >
                          ...
                          <p
                            style={{ color: "#A0A7AF" }}
                            className="ff-gotham-normal mb-0 fs_12 text-wrap"
                          >
                            {chat.content}{" "}
                          </p>
                          <p
...
export default AthleteChatRoom;
