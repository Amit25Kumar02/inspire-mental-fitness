...
import { getFocusFieldDailyLeaderBoard } from "../../../../services/FocusFieldLeaderboardService";
import "bootstrap/dist/css/bootstrap.min.css";
// import backgroundImage from "../../../../assets/image/png/leaderBoard-1.png"
...
import Avatar4 from "../../../../assets/avatars/menavatar.png";
...
const avatarList = [maleAvatar, Avatar1, Avatar2, Avatar3, Avatar4];

const FocusFieldDailyLeaderBoard = () => {
  ...
  useEffect(() => {
    const fetchLeaderboard = async () => {
      try {
        const res = await getFocusFieldDailyLeaderBoard();
        const leaderboardData = res?.data?.leaderboard || res?.leaderboard;

        let updatedPlayers;

        if (leaderboardData?.length > 0) {
          updatedPlayers = assignRandomAvatar(leaderboardData);
        } 
...
export default FocusFieldDailyLeaderBoard;