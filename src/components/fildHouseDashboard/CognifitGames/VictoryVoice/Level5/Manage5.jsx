...
import StartLogo from '../../../../../assets/image/png/lead-light.png';
import { FaArrowRight } from "react-icons/fa6";
import { useDispatch, useSelector } from "react-redux";
import { startLevel5 } from "../../../../../redux/slice/GamesSlice";
    ...
    <div>
      <div className="text-white min-vh-100 d-flex flex-column justify-content-center align-items-center text-center">
        ...
        <div className="voice-of-truth-content">
          <h2 className="fw-bold mt-4">Lead with Light</h2>
          <p className="lead mt-2 px-3 px-md-5 text-center">
            This level has 80 detailed scenarios, organized by stage, with negative vs. positive responses.
          </p>
        </div>

        <button className="btn green-btn" onClick={() => {
          dispatch(startLevel5(true));
        }}>Start Game</button>
