...
import StartLogo from '../../../../../assets/image/png/VictoryLevel1.png';
import { FaArrowRight } from "react-icons/fa6";
import { useDispatch, useSelector } from "react-redux";
import { startForNow } from "../../../../../redux/slice/GamesSlice";
      ...
      <div className="text-white min-vh-100 d-flex flex-column justify-content-center align-items-center text-center">
        ...
        <div className="voice-of-truth-content">
          ...
          <p className="lead mt-2 px-3 px-md-5 text-center">
            Athletes learn how the words they choose → internally and externally → shape confidence,
            focus, and team energy.
          </p>
        </div>

        <button className="btn green-btn" onClick={() => {
          dispatch(startForNow(true));
        }}>Start Game</button>
