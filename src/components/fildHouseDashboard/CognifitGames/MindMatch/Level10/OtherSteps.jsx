    ...
    return (
        <div>
            <div className="d-flex gap-4 flex-column justify-content-center align-items-center text-center">
                <button className="btn green-btn border-rounded">Level 10</button>
                <p className="mb-4 h6 text-uppercase">Spiral + Critic + Freeze - combined (STAGE {data?.stage})</p>
            </div>

             <Progress step={data?.step} totalSteps={15} />
            ...
            <div className="d-flex flex-column justify-content-center align-items-center text-center p-5">
                ...
                <p className="mb-4 h6 light-back-txt gothamMedium">Choose the champion response.</p>
