    ...
    return (
        <div>
            <div className="d-flex gap-4 flex-column justify-content-center align-items-center text-center">
                <button className="btn green-btn border-rounded">Level 9</button>
                <p className="mb-4 h6 text-uppercase">FOG – returns stronger (STAGE {data?.stage})</p>
            </div>
            ...
            <div className="d-flex flex-column justify-content-center align-items-center text-center p-5">
                ...
                <p className="mb-4 h6 light-back-txt gothamMedium">What is the best leadership move now?</p>
