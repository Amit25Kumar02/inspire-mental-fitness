    ...
    return (
        <div>
            <div className="d-flex gap-4 flex-column justify-content-center align-items-center text-center">
                <button className="btn green-btn border-rounded">Level 6</button>
                <p className="mb-4 h6 text-uppercase">MIRROR – Identity Doubt (STAGE {data?.stage})</p>
            </div>

            <Progress step={data?.step} totalSteps={(data?.stage === 1 || data?.stage === 2) ? 10 : 20} />
