    ...
    return (
        <div>
            <div className="d-flex gap-4 flex-column justify-content-center align-items-center text-center">
                <button className="btn green-btn border-rounded">Level 8</button>
                
                <p className="mb-4 h6 text-uppercase">PRESSURE COOKER– stronger form (STAGE {data?.stage})</p>
            </div>
            ...
            <div className="d-flex flex-column justify-content-center align-items-center text-center p-5">
                ...
                <p className="mb-4 h6 light-back-txt gothamMedium">What is your best clutch response?</p>
