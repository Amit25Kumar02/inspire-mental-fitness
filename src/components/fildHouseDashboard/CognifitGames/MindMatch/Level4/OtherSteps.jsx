    ...
    return (
        <div>
            <div className="d-flex gap-4 flex-column justify-content-center align-items-center text-center">
                <button className="btn green-btn border-rounded">Level 4</button>
                <p className="mb-4 h6 text-uppercase">Critic – Negative Noise (STAGE {data?.stage})</p>
            </div>

            <Progress step={data?.step} totalSteps={40} />
