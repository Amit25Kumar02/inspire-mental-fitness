...
import laptopWithClock from "../../../assets/image/png/watchOnLaptopblue.png";
    ...
    <div className="pb-5 pt-4">
      <div className="d-flex align-items-center gap-4 mt-4">
        {["All", "Recent", "Upcoming"]?.map((tab) => (
          <Button
            key={tab}
            className={`btn-sessions-tab-coach w-100 fs-15 ${
              activeTab === tab
                ? "btn-sessions-tab-active-coach ff-gotham-bold"
                : "ff-gotham-normal"
            }`}
                ...
                >
                  ...
                  <div className="py-3 px-5 text-center">
                    <Link target="_blank" to={value?.zoomLink}>
                      <Button
                        className={`btn-sessions-tab-active-coach w-100 mx-auto py-2 rounded-3 ff-gotham-medium `}
                      >
                        Join Meeting
                      </Button>
                    </Link>
