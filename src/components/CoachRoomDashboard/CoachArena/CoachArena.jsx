...
const CoachArena = () => {
  ...
  return (
    <div className="my-4">
      <Row className="pt-1">
        {/* Top Section */}
        <div className="bg_blue bg_image p-sm-5 px-3 py-4 rounded-4 position-relative overflow-hidden">
          <img
        ...
        {data?.length === 0 ? (
          ...
          <>
            <Row className="py-3">
              {Array.isArray(data) &&
                data.slice(0, pageLimit).map((value, index) => {
                  const cardContent = (
                    <Card
                      bodyStyle={{ padding: 0 }}
                    ...
                    >
                      <div>
                        ...
                        >
                          {/* Zoom Link */}
                          {value?.zoomLink ? (
                            <Link to={value?.zoomLink} target="_blank">
                              <img
                                src={meetingIcon}
                                alt="zoom"
                                style={{
                  ...
                  return (
                    <Col lg={3} sm={6} key={index} className="mt-4">
                      {/* Links based on type */}
